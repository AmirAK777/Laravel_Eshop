<form wire:submit.prevent="save" class="border rounded shadow-lg">
    <div class="flex justify-between p-4 font-medium border-b">
        <span class="text-xl">{{ ucfirst($type) }} {{ __('messages.details') }}</span>
    ...
    <div class="p-4 space-y-4">
        ...
        <dl class="flex">
            <div class="w-1/2">
                <div class="space-y-4">
                    <div>
                        <dt class="text-sm font-medium">{{ __('messages.name') }}</dt>
                        <dd>{{ $address->first_name }} {{ $address->last_name }}</dd>
                    </div>

                    <div>
                        <dt class="text-sm font-medium">{{ __('labels.company') }}</dt>
                        <dd>{{ $address->company_name }}</dd>
                    </div>

                    <div>
                        <dt class="text-sm font-medium">{{ __('labels.phone_number') }}</dt>
                        <dd>{{ $address->contact_phone }}</dd>
                    </div>

                    <div>
                        <dt class="text-sm font-medium">{{ __('labels.email') }}</dt>
